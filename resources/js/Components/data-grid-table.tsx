        ...
        <thead
            className={cn(
                ...
                props.tableLayout?.headerSticky &&
                    props.tableClassNames?.headerSticky
            )}
        >
            {children}
        </thead>
...
function DataGridTableRowSelect<TData>({
    ...
    const sizeClass =
        size === "md" ? "w-5 h-5" : size === "lg" ? "w-6 h-6" : "w-4 h-4";
    ...
    return (
        <>
            ...
            <Checkbox
                ...
                className={cn("align-[inherit]", sizeClass)}
            />
        </>
    );
}
            ...
            <div className="flex flex-wrap items-center space-x-2.5 pb-2.5 sm:pb-0 order-2 sm:order-1">
                {isLoading ? (
                    ...
                    <>
                        ...
                        >
                            <SelectTrigger className="w-fit px-2 py-1 text-sm">
                                {" "}
                                {/* size handled via Tailwind */}
