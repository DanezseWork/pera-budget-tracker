...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, variant, size, onClick, ...props }, ref) => {
        ...
        const handleClick = (e: React.MouseEvent<HTMLButtonElement>) => {
            ...
            window.setTimeout(
                () => btn.classList.remove("btn-bounce-anim"),
                300
            );
        ...
        const classes = cn(
            buttonVariants({ variant, size }) as string,
            className ?? ""
        );
        return (
            <button
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    <div className="flex-shrink-0">
                        <a
                            href="/"
                            className="text-xl font-bold tracking-tight transition-opacity"
                        >
                            {brand}
                        </a>
                    </div>
                                ...
                                <div className="flex flex-col space-y-2">
                                    ...
                                    <div className="pt-2 space-y-2">
                                        <Button
                                            size="sm"
                                            variant="default"
                                            className="w-full justify-center focus-outline"
                                            onClick={() => {
                                                setMenuOpen(false);
                                                onSignIn?.();
                                            }}
    ...
    return (
        ...
        >
            <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
                <h1
                    id="hero-heading"
                    className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tighter leading-tight animate-fade-in-up mb-6"
                >
                    ...
                    <span className="relative inline-block">
                        <span
                            className={cn(
                                heroClassName ?? "",
                                "font-normal text-5xl sm:text-6xl md:text-7xl text-green-400"
                            )}
                        >
                            Pera
                        </span>
